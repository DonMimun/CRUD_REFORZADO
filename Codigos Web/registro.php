...
<head>
    ...
    <!-- proteccion contra ataques XXS y csp -->
    ...
    <!-- He usado el mismo estilo que login-->
    ...
    <section>
        <div class="contenedor">
            <div class="formulario">
                ...
                <form action="recursos/registroscript.php" method="post">
                    ...
                    <div class="input-contenedor">
                        ...
                        <label for="#"><i class="fas fa-satellite"></i> Correo</label>
                    </div>

                    <div class="d-flex justify-content-center align-items-center mb-2 recaptcha-container">
                        <div class="g-recaptcha" data-sitekey="6LeKzLApAAAAAMOtqyGbZpSrZnr_eqwUkAKGXKsC"></div>
                    </div>
                    
                    <div>
                        <button class="my-custom-btn">Crear cuenta</button>

                        <div class="registrar">
                            <p> Ya tengo cuenta: <a href="login.php">Iniciar</a></p>
                        </div>
                    </div>
            </form>
            </div>
